const PrivateHeader = () => {
    return (
        <header className="sticky top-0 z-10 w-full bg-background-dark/80 backdrop-blur-sm">
            <div className="container mx-auto flex items-center justify-between whitespace-nowrap border-b border-solid border-border-dark-game px-4 sm:px-6 lg:px-8 py-3">
                {/* Logo and Title */}
                <div className="flex items-center gap-4 text-gray-100">
                    <div className="size-8 text-highlight-green">
