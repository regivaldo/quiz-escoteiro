const ProfilePage = () => {
    ...
    const stats = [
        { icon: "star", label: "Pontuação Total", value: "12,450", color: "primary" },
        { icon: "quiz", label: "Quizzes Concluídos", value: "15", color: "primary" },
        { icon: "workspace_premium", label: "Conquistas", value: "8", color: "primary" }
    ];

    const quizHistory = [
        { name: "Especialidade de Nós", score: 850, date: "15 de Julho, 2024" },
        { name: "História do Escotismo", score: 920, date: "12 de Julho, 2024" },
