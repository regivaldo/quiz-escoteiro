    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-2xl">
                ...
                <div className="mb-8 w-full">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex-grow">
                            <p className="text-sm font-medium text-text-on-light/80 dark:text-text-on-dark/80 mb-2">
                                Pergunta {currentQuestion} de {totalQuestions}
                            </p>
                            <div className="h-2 w-full rounded-full bg-surface-light dark:bg-surface-dark shadow-inner">
                                <div
                ...
                {/* Main Quiz Card */}
                <div className="flex w-full flex-col items-center rounded-xl bg-surface-light dark:bg-surface-dark p-6 sm:p-8 shadow-lg">
                    {/* Question */}
                    <h1 className="mb-8 text-center text-2xl font-bold leading-tight tracking-tight text-text-on-light dark:text-text-on-dark sm:text-3xl">
                        {question}
                    </h1>
