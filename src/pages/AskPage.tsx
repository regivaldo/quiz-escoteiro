const AskPage = () => {
    ...
    const getOptionClasses = (state: string) => {
        if (state === "incorrect") {
            return "bg-feedback-incorrect/20 dark:bg-feedback-incorrect/30 text-text-light dark:text-text-dark ring-2 ring-feedback-incorrect";
        }
        if (state === "correct") {
            return "bg-primary/20 dark:bg-primary/30 text-text-light dark:text-text-dark ring-2 ring-primary";
        }
        return "bg-background-light dark:bg-background-dark hover:bg-secondary/20 dark:hover:bg-secondary/30 ring-1 ring-inset ring-black/10 dark:ring-white/10 hover:ring-secondary";
    };

    const getOptionIcon = (state: string, id: string) => {
        if (state === "incorrect") {
            return (
                <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-feedback-incorrect text-white">
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-2xl">
                ...
                <div className="mb-8 w-full">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex-grow">
                            ...
                            <div className="h-2 w-full rounded-full bg-surface-light dark:bg-surface-dark-ask shadow-inner">
                                <div
                        ...
                        {/* Timer */}
                        <div className="flex items-center gap-2 rounded-lg bg-surface-light dark:bg-surface-dark-ask p-2 shadow-sm">
                ...
                {/* Main Quiz Card */}
                <div className="flex w-full flex-col items-center rounded-xl bg-surface-light dark:bg-surface-dark-ask p-6 sm:p-8 shadow-lg">
                    {/* Question */}
                    <h1 className="mb-8 text-center text-2xl font-bold leading-tight tracking-tight text-text-light dark:text-text-dark sm:text-3xl">
                        {question}
                    </h1>
