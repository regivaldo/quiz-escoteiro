                        ...
                        <main className="flex-grow pt-10 pb-16">
                            ...
                            <div className="mt-4">
                                <p className="text-text-dark text-base font-normal leading-relaxed pb-3 pt-1 px-4 text-center max-w-3xl mx-auto">
                                    O <strong>Quiz Escoteiro</strong> nasceu com o objetivo de tornar mais fácil e divertido para novos jovens do movimento escoteiro a aprenderem as leis e a promessa, conseguindo assim cumprir as etapas do Período Introdutório. Para os jovens com mais experiência, o Quiz Escoteiro ajudará a dominar diversos assuntos, como Promessa, Lei, Primeiro Socorros, História do Escotismo no Brasil, entre outros. O sistema foi pensado de modo a levar o Quiz Escoteiro gratuitamente para todos. Importante frizar que o Quis Escoteiro é basedo nos manuais e literaturas da União dos Escoteiros do Brasil.
                                </p>
                            </div>
