          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <main className="flex-grow pt-10 pb-16 px-4">
              <div className="prose prose-lg max-w-none">
                <h2 className="text-[#444] text-3xl font-bold mb-6">Política Privacidade</h2>

                <p className="text-[#444] text-base leading-relaxed mb-4">
                  A sua privacidade é importante para nós. É política do Quiz Escoteiro respeitar a sua privacidade em
                  relação a qualquer informação sua que possamos coletar no site{' '}
                  <a href="https://quiz-escoteiro.com.br" className="text-primary hover:underline">
                    Quiz Escoteiro
                  </a>
                ...
                <h3 className="text-[#444] text-2xl font-bold mb-4 mt-8">Compromisso do Usuário</h3>

                <p className="text-[#444] text-base leading-relaxed mb-4">
                  O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Quiz Escoteiro
                ...
                <ul className="list-disc pl-6 mb-6 space-y-2">
                  ...
                  <li className="text-[#444] text-base leading-relaxed">
                    C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Quiz Escoteiro, de
                ...
                <h3 className="text-[#444] text-2xl font-bold mb-4 mt-8">Mais informações</h3>
                ...
                <p className="text-[#444] text-base leading-relaxed">
                  Esta política é efetiva a partir de 2 December 2025 12:58
                </p>
              </div>
            </main>
          </div>
