      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-4 py-20 pt-32 text-center">
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center gap-12">
          ...
          <button
            ...
            className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-14 px-8 bg-primary text-white text-lg font-bold leading-normal tracking-[0.015em] transition-transform hover:scale-105 shadow-lg"
          >
        ...
        <div className="container mx-auto max-w-5xl px-4">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="max-w-3xl text-lg leading-relaxed text-gray-600 mb-12">
              Bem-vindo ao Quiz Escoteiro! Nossa missão é testar seus conhecimentos sobre o escotismo de uma forma
              divertida e educativa. Prepare sua mochila, afie sua mente e embarque nesta jornada de aprendizado e
              aventura.
            </p>
