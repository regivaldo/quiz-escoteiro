      ...
      <div className="w-full max-w-2xl px-4 py-8">
        ...
        <div className="mt-8 overflow-hidden rounded-xl bg-white shadow-lg">
          ...
          <div className="p-6 text-center sm:p-8">
            <p className="text-sm font-medium uppercase tracking-wider text-gray-500">Sua Pontuação Final</p>
            <div className="mt-4 flex items-baseline justify-center gap-2">
              <span className="text-7xl font-bold tracking-tighter text-primary">{totalPoints}</span>
              <span className="text-2xl font-semibold text-gray-400">pontos</span>
            </div>
          ...
          <div className="grid grid-cols-1 border-t border-gray-200 sm:grid-cols-2">
            ...
            <div className="flex flex-col items-center gap-2 border-b p-6 sm:border-b-0 sm:border-r">
              ...
              <p className="text-2xl font-semibold text-[#1c1e14]">{correctAnswers}</p>
            </div>
            ...
            <div className="flex flex-col items-center gap-2 p-6">
              ...
              <p className="text-2xl font-semibold text-[#1c1e14]">{incorrectAnswers}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row sm:flex-wrap">
          {/* Play Again */}
          <button
            className="flex h-12 w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg bg-primary px-6 text-base font-bold text-[#1c1e14] shadow-md transition-transform hover:scale-105 active:scale-100 sm:w-auto"
            onClick={playAgain}
          >
